                    ...
                    <div class="card-header pb-0">
                        <div class="card-header pb-0">
                            <a href="invoices/create" class="modal-effect btn btn-sm btn-primary" style="color:white"><i
                                    class="fas fa-plus"></i>&nbsp;
                                اضافة فاتورة</a>
                            <a href="{{route('invoice.export')}}" class="modal-effect btn btn-sm btn-success" style="color:white"><i
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="example1" class="table key-buttons text-md-nowrap">
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu tx-13">
                                                ...
                                                <a class="dropdown-item" href="{{route('archive',$invoice->id)}}" >
                                ...
                                @empty
                                    <tr>
                                        <td colspan="12" class="text-center">لا يوجد فواتير</td>
                                    </tr>
                                @endforelse
                                </tbody>
                            </table>
